...
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C654', '75AZ92', 2015, 4, 'A-125', 70, 3, 'Montreuil', 'Montreuil', null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C655', '42RL75', 2015, 4, 'A-126', 678, 7, 'Lyon', 'lyon', null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C656', '56AA46', 2015, 4, 'B-236', 59, 1, 'Paris', 'Paris', null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C657', '11TR62', 2015, 4, 'B-237', 125, 2, 'Montreuil', 'Montreuil', null, null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C656', '42RL75', 2015, 4, 'C-45', 253, 4, 'Lyon', 'Lyon', null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C655', '71BB37', 2015, 4, 'C-34', 86, 3, 'Neuilly', 'Neuilly', null, null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C664', '75AZ92', 2017, 2, 'C-35', 386, 8, 'Courbevoie', 'Neuilly',null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C662', '71BB37', 2015, 5, 'C-36', 816, 8, 'Neuilly', 'Neuilly', null,null);
INSERT INTO `loueur`.`location` (`codeC`, `immat`, `annee`, `mois`, `numLoc`, `km`,`duree`, `villeD`, `villeA`,`dateD`,`dateF`) VALUES ('C669', '75AZ92', 2016, 5, 'C-37', 45, 2, 'Paris', 'Lyon', null, null);
...
select nom from client where prenom = "Jean" order by nom DESC;
...
values ('10AK37', 'Peugeot', '205', 'cabriolet', 'violet', 2, 1980,65000, 40,'P99'); 

insert into voiture (immat, modele, marque, categorie, couleur, places, achatA, compteur,prixJ, codeP)
values ('11BF37', 'Peugeot', '206', 'cabriolet', 'violet', 2, 1980,21000, 32,'P99');

insert into voiture (immat, modele, marque, categorie, couleur, places, achatA, compteur,prixJ, codeP)
values ('15AK37', 'Peugeot', '205', 'cabriolet', 'violet', 2,1985,27000,30,'P99'); 

select * from voiture where immat ="10AK37";
select * from voiture where immat ="11BF37";
select * from voiture where immat ="15AK37";

select * from voiture where immat="63GH94";
select * from voiture where immat="87AZ92";

select count(distinct immat) from voiture;
select count(distinct immat) from voiture where couleur="violet";

update voiture set couleur="blanc" where immat="11BF37";
delete from voiture where couleur="violet"; #ne marche pas car la protection est ON
show variables like 'sql_safe_updates' ;
set sql_safe_updates = 0 ; #Mettre updates à 0 car delete bug
delete from voiture where couleur = "violet"; 
select count(distinct immat) from voiture;
#delete from voiture where codeP='P89';

# PARTIE 1.4
alter table location add note int check(note>=0 and note <=5);
alter table location add appreciation Varchar(120);
